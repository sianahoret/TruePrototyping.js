...
| *tpHasProperty*(propName) method | Returns true if the object which the method is called on has the specified property (either own or inherited, enumerable or not), otherwise false. In other words, this method is similar to standard 'hasOwnProperty', but without 'own' restriction. The method returns true even if the specified property is defined in ancestor as not enumerable and has the value of type "undefined" :) |
