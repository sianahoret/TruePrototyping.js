...
| *tpHasProperty*(propName) | Returns a boolean indicating whether an object contains the specified property directly or inherited. The method returns true even if the specifies property is defined in ancestor and has value of type "undefined" :) |
