...
| *tpAncestorHaving*(propertyName) method                  | Returns the nearest ancestor, responding to the specified property. The method can be useful, when you need to find the ancestor matching the condition, but unlike in case of calling tpSuperImmediate you need to execute the specified property/method propertyName on its owner, not on 'this'. |
| *tpAncestorHavingOwn*(propertyName) method               | Returns the nearest ancestor, having own specified property. The method can be useful, when you need to find the ancestor matching the condition, but unlike in case of calling tpSuper you need to execute the specified property/method propertyName on its owner, not on 'this'. |
