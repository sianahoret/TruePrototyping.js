...
<b>Aim</b> :: <b>Stuff to achieve the aim</b>
A compact syntax for construction of object hierarchy with intuitively clear object relationship :: *tpDerive* method
A convenient and uniform way for introspection and lookup of true prototype chain, even if object hierarchy was created with "traditional" style :: *tpAncestor* and *tpAncestors* properties, *tpSuper*, *tpIsAncestorOf* and *tpIsDescendantOf* methods

=== Creation of object hierarchy with 'tpDerive' method
...
TruePrototyping library provides a few properties and methods, which allow to walk through true prototype chain: 'tpAncestor' and 'tpAncestors' properties, 'tpSuper', 'tpIsAncestorOf' and 'tpIsDescendantOf' methods. Moreover, it allows to do that in the same way for object hierarchies created by different frameworks.
